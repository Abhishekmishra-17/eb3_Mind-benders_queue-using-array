...
/////////////// Write the MCQ below in the exactly same described format ///////////////
  ...
  const myQuestions = [
    {
      question: "enQueue() is call only when:-",  ///// Write the question inside double quotes
      answers: {
    ...
    {
      question: "Name of pointer that is used for the end side",  ///// Write the question inside double quotes
      answers: {
      ...
      correctAnswer: "c"                ///// Write the correct option inside double quotes
    									                  ...
    									                  ///// this line
     {
      question: "IsEmpty() funtion is used to:-",
      answers: {
